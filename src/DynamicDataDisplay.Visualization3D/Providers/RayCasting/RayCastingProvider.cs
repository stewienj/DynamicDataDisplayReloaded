using DynamicDataDisplay.Visualization3D.Auxilaries;
using DynamicDataDisplay.Visualization3D.MainLoops;
using DynamicDataDisplay.Visualization3D.VertexStructures;
using SlimDX;
using SlimDX.Direct3D9;
using System;

namespace DynamicDataDisplay.Visualization3D.RayCasting
{
	public class RayCastingProvider : DrawableComponent
	{
		...
		public override void Initialize()
		{
			...
			if (effect == null)
			{
				effect = Effect.FromStream(device, this.GetType().Assembly.GetManifestResourceStream("DynamicDataDisplay.Visualization3D.Shaders.RayCasting.fx"), ShaderFlags.None);
			}
			...
			denModTex = Texture.FromStream(device, this.GetType().Assembly.GetManifestResourceStream("DynamicDataDisplay.Visualization3D.Textures.denmod.dds"), Usage.Dynamic, Pool.Default);
