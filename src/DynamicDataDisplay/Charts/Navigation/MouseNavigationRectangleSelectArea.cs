...
{
    public class MouseNavigationRectangleSelectArea : NavigationBase
    {
        ...
        private void OnMouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (_isDrawing && e.LeftButton == MouseButtonState.Pressed)
            {
                ...
                if (shift.X != 0 || shift.Y != 0)
                {
                    ...
                    SelectedAreaPath[1] = new Point(_lastDrawingDataPoint.X, firstPoint.Y);
                    SelectedAreaPath[2] = _lastDrawingDataPoint;
                    SelectedAreaPath[3] = new Point(firstPoint.X, _lastDrawingDataPoint.Y);
                }
        ...
        public static readonly DependencyProperty SelectedAreaPathProperty =
            DependencyProperty.Register("SelectedAreaPath", typeof(IList<Point>), typeof(MouseNavigationRectangleSelectArea), new PropertyMetadata(new List<Point>()));
    }
}
