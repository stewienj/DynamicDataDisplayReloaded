...
namespace Microsoft.Research.DynamicDataDisplay
{
	...
	{
		public const double DefaultEnlargeFactor = 1.05;

		private readonly Plotter2D plotter;
		public Plotter2D Plotter2D
		{
			get { return plotter; }
		}
		...
		public DataRect Visible
		{
			...
			set
			{
				...
				{
					Trace.WriteLine("ERROR: Viewport2D.Visible(): " + e.Message);
				}
			}
		}
		...
		private static object OnCoerceVisible(DependencyObject d, object newValue)
		{
			...
			if (newRect.Width == 0 || newRect.Height == 0 || newRect.IsNaN())
			{
		...
		private double clipToBoundsEnlargeFactor = DefaultEnlargeFactor;
		/// <summary>
		...
		public event EventHandler<ValueChangedEventArgs<Viewport2DPanningState>> PanningStateChanged;
